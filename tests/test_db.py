...
def test_insert_review(temp_db):
    review_id = insert_review(temp_db, "Test Review", "https://github.com/test", "Test Template", "Test Prompt")
...
def test_insert_file(temp_db):
    review_id = insert_review(temp_db, "Test Review", "https://github.com/test", "Test Template", "Test Prompt")
    file_id = insert_file(temp_db, review_id, "test.py", "test diff", "test code", "test response")
...
def test_delete_review(temp_db):
    review_id = insert_review(temp_db, "Test Review", "https://github.com/test", "Test Template", "Test Prompt")
    insert_file(temp_db, review_id, "test.py", "test diff", "test code", "test response")
...
def test_get_all_reviews(temp_db):
    insert_review(temp_db, "Test Review 1", "https://github.com/test1", "Test Template 1", "Test Prompt 1")
    insert_review(temp_db, "Test Review 2", "https://github.com/test2", "Test Template 2", "Test Prompt 2")
...
def test_get_review_with_files(temp_db):
    review_id = insert_review(temp_db, "Test Review", "https://github.com/test", "Test Template", "Test Prompt")
    insert_file(temp_db, review_id, "test1.py", "test diff 1", "test code 1", "test response 1")
    insert_file(temp_db, review_id, "test2.py", "test diff 2", "test code 2", "test response 2")
...
def test_insert_review_exception(temp_db):
    with pytest.raises(sqlite3.Error) as excinfo:
        insert_review(temp_db, None, "https://github.com/test", "Test Template", "Test Prompt")
...
def test_insert_file_exception(temp_db):
    ...
    with pytest.raises(ValueError) as excinfo:
        insert_file(temp_db, non_existent_review_id, "test.py", "test diff", "test code", "test response")
    assert str(excinfo.value) == f"Review with id {non_existent_review_id} does not exist"
