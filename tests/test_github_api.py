...
def test_identify_github_url_type(mock_github_api):
    cases = [
        ...
        ("https://github.com/owner/repo/tree/branch/folder/subfolder", GitHubURLType.FOLDER_PATH),
        ...
        ("https://github.com/owner/repo/pull/123/commits/abcdef1234567890abcdef1234567890abcdef12", GitHubURLType.PULL_REQUEST_COMMIT),
    ...
    mock_github_api.is_branch.side_effect = lambda repo, ref, exact_match: ref == 'branch'
...
def test_github_api_get_repo(mock_github_api):
    ...
    mock_github_api.get_repo = MagicMock(side_effect=lambda repo_name: mock_github.get_repo(repo_name))
